...
public interface EditableRGBImage extends RGBImage, ImageEditable {
    ...
    /**
     * この{@code EditableRGBImage}の指定された{@link Vector2i}の位置にRGB24の{@code int}を指定して色を設定します。
     *
    ...
    /**
     * この{@code EditableRGBImage}の指定されたx, yの位置に{@link RGB24Color}を指定して色を設定します。
     *
     * @param x     色を設定するx位置
     * @param y     色を設定するy位置
     * @param color 設定する色
    ...
    /**
     * この{@code EditableRGBImage}の指定された{@link Vector2i}の位置に{@link RGB24Color}を指定して色を設定します。
     *
     * @param position 色を設定する位置
     * @param color    設定する色
     */
