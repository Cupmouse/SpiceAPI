...
public interface RGB24ImageBuilder<T extends RGB24Image> extends ImageBuilder<T> {
     ...
     *
     * @param backgroundColor 作成する{@link RGB24Image}の背景色
     */
    RGB24ImageBuilder<T> background(RGB24Color backgroundColor);
     ...
     */
    RGB24ImageBuilder<T> background(@Min(0) @Max(0xFFFFFF) int backgroundColor) throws IllegalArgumentException;
}